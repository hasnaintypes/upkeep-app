...
import { AI_AGENTS, AI_MCP_CONTENT, AI_SECTION_CONTENT, AI_TRIAGE_CONTENT } from "../constants/ai-section";
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          >
            ...
            <span className="text-zinc-400 text-sm">{AI_SECTION_CONTENT.label}</span>
          ...
          >
            <span className="text-white font-medium">{AI_SECTION_CONTENT.descriptionLead}</span>{" "}
            {AI_SECTION_CONTENT.description}
          </motion.p>
          ...
          >
            {AI_SECTION_CONTENT.learnMoreCta}
            ...
            >
              ...
              >
                ...
                <div className="bg-zinc-800/50 border border-zinc-700 rounded-t-xl px-5 py-4">
                  <span className="text-zinc-500 italic">{AI_SECTION_CONTENT.assignPlaceholder}</span>
                </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="border-t border-r border-b border-zinc-800/60 pt-12 pr-12 pb-16">
                <h3 className="text-zinc-200 font-medium text-xl mb-3">{AI_TRIAGE_CONTENT.heading}</h3>
                <p className="text-zinc-500 text-base mb-8">{AI_TRIAGE_CONTENT.description}</p>
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5">
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <span className="text-zinc-500 text-sm">
                      {AI_TRIAGE_CONTENT.cardLabelPrefix}{" "}
                      <span className="text-zinc-300">{AI_TRIAGE_CONTENT.cardLabelSuffix}</span>
                    </span>
                  </div>

                  {/* Suggestions Row */}
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-zinc-600 text-sm w-20">{AI_TRIAGE_CONTENT.suggestionsLabel}</span>
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <span className="text-white">{AI_TRIAGE_CONTENT.suggestionName}</span>
                      </span>
                  ...
                  {/* Duplicate Row */}
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-zinc-600 text-sm w-20">{AI_TRIAGE_CONTENT.duplicateLabel}</span>
                  </div>

                  {/* Related Row */}
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-zinc-600 text-sm w-20">{AI_TRIAGE_CONTENT.relatedLabel}</span>
                  </div>
                  ...
                  <div className="bg-zinc-800/40 rounded-lg p-4 ml-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-zinc-300 text-sm font-medium">{AI_TRIAGE_CONTENT.suggestedAssignee}</span>
                    </div>

                    <p className="text-zinc-500 text-xs mb-2">{AI_TRIAGE_CONTENT.whyLabel}</p>
                    <p className="text-zinc-500 text-sm mb-4">{AI_TRIAGE_CONTENT.whyDescription}</p>

                    <p className="text-zinc-500 text-xs mb-2">{AI_TRIAGE_CONTENT.alternativesLabel}</p>
                    <div className="flex items-center gap-2 mb-4">
                      {AI_TRIAGE_CONTENT.alternatives.map((name) => (
                        <span
                          key={name}
                          className="flex items-center gap-1.5 bg-zinc-700/50 rounded-md px-2 py-1 text-sm"
                        >
              ...
              <div className="border-t border-b border-zinc-800/60 pt-12 pl-12 pb-16">
                <h3 className="text-zinc-200 font-medium text-xl mb-3">{AI_MCP_CONTENT.heading}</h3>
                <p className="text-zinc-500 text-base mb-8">{AI_MCP_CONTENT.description}</p>

                {/* MCP Code Snippet */}
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5 font-mono text-sm">
                  <p className="text-zinc-700 mb-3">{AI_MCP_CONTENT.endpointComment}</p>
                  <div className="space-y-1 mb-6">
                    <p>
                      <span className="text-orange-400/70">&quot;{AI_MCP_CONTENT.snippet.key1}&quot;</span>
                      <span className="text-zinc-500">: {"{"}</span>
                    </p>
                    <p className="pl-4">
                      <span className="text-orange-400/70">&quot;{AI_MCP_CONTENT.snippet.key2}&quot;</span>
                      <span className="text-zinc-500">: {"{"}</span>
                    </p>
                    <p className="pl-8">
                      <span className="text-orange-400/70">&quot;{AI_MCP_CONTENT.snippet.key3}&quot;</span>
                      <span className="text-zinc-500">: </span>
                      <span className="text-green-400/70">&quot;{AI_MCP_CONTENT.snippet.value}&quot;</span>
                    </p>
                  </div>
                  ...
                  <div className="bg-zinc-800/40 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-zinc-600">{AI_MCP_CONTENT.askPlaceholder}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <button className="flex items-center gap-1.5 border border-zinc-700/60 text-zinc-500 text-sm px-3 py-1.5 rounded-full hover:bg-zinc-700/30 transition-colors">
                        ...
                        {AI_MCP_CONTENT.actions[0]}
                      </button>
                      <button className="flex items-center gap-1.5 border border-zinc-700/60 text-zinc-500 text-sm px-3 py-1.5 rounded-full hover:bg-zinc-700/30 transition-colors">
                        <Globe className="w-3.5 h-3.5" />
                        {AI_MCP_CONTENT.actions[1]}
                      </button>
                      <button className="flex items-center gap-1.5 border border-zinc-700/60 text-zinc-500 text-sm px-3 py-1.5 rounded-full hover:bg-zinc-700/30 transition-colors">
                        <Lightbulb className="w-3.5 h-3.5" />
                        {AI_MCP_CONTENT.actions[2]}
                      </button>
                    </div>
                  </div>
                </div>
